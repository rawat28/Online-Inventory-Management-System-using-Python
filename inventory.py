...
class Application:
    def __init__(self, master, *args, **kwargs):
        ...
        self.date_l = Label(self.right, text="Date: " + current_date, font='Calibre 18 bold', fg='black')
    ...
    def ajax(self, *args, **kwargs):
        ...
        self.pc = self.my_cursor.fetchall()
        if self.pc:
            ...
            self.change_l = Label(self.left, text="Enter the amount paid", font='Calibre 20 bold', fg='black',
                                  bg='white')
        ...
        def add_to_cart(self, products_list=None, product_price=None, product_quantity=None, product_id=None, *args,
                            **kwargs):
